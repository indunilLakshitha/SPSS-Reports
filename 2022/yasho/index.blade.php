                    ...
                    <div class="page-row">
                        ...
                        <div class="card page">
                            ...
                            @isset($stepSheduleFormat)
                                <p class="into-para">{{$stepSheduleFormat->introduction_message ? $stepSheduleFormat->introduction_message : '' }}
                                </p>
                            @else
                                <p class="into-para">''</p>
                            @endisset
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="button"
                                            onclick="submitCommentStepSeven('{{ $id }}','{{ $unique_code }}')"
                                            data-bs-dismiss="modal" class="btn btn-primary">はい
                                        </button>
                                    </div>
                                </div>
                            </div>
